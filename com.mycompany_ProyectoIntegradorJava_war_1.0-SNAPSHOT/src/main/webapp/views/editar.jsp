        ...
        <div class="container mt-5">
            ...
            <form action="EmpleadoController" method="post">
                ...
                <table class="table table-bordered mt-3">
                    <tr>
                        <td>Producto:</td>
                        <td><input type="text" name="producto" class="form-control" size="50" value="${empleado.producto}"></td>
                    </tr>
                    <tr>
                        <td>Marca:</td>
                        <td><input type="text" name="marca" class="form-control" size="50" value="${empleado.marca}"></td>
                    </tr>
